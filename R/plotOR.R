...
#'
#' @param x An object of class "OR" generated by the \code{\link{odds.ratio}} function.
...
#' @param pred.value The predicted value at which to calculate the smooth odds ratios. Default is NULL.
...
#'
#' @examples
#' # Assuming "or_data" is a data frame with necessary columns
#' library(smoothOR)
#' fit <- gam(formula = y ~ s(x), data = or_data)
#' or <- odds.ratio(fit, dataset = or_data)
#' plot.OR(or, predictor = "x")
#'
#' @importFrom gam gam
#' @importFrom mgcv gam
#' @export
